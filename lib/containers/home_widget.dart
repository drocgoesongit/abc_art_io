...
class HomeWidget extends StatelessWidget {
  ...
  HomeWidget({required this.toHome, required this.toAbout, required this.toService, required this.toProject, required this.toTestimonial});
                        ...
                        children:  [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              const Text("Hello, I am Nabeel 👋", style: kButtonText,),
                            ],
                          ),
                          const SizedBox(
                            height: 40.0,
                          ),
                          const Text("App Dev enabling brands to flow with change in order to grow 🚀", style: kTextStyleWhite,),
                          const SizedBox(
                            height: 40.0,
                          ),
                          MaterialButton(
